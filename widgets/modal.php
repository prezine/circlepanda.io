  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body text-center">
          ...
          <div class="form-group">
            <div class="input-group inpit-group-merge">
              ...
              <div class="input-group-append">
                <a class="input-group-text text-decoration-none text-gray-500" id="signInPasswordCaption" data-toggle="password" href="index.html#signInPassword">
                  <i class="fe fe-eye"></i>
                </a>
              </div>
            </div>
        ...
        <!-- Link -->
        <a class="font-size-sm" href="password-reset.html">
        ...
        <form class="mb-6">
          ...
          <div class="form-group">
            <div class="input-group inpit-group-merge">
              ...
              <div class="input-group-append">
                <a class="input-group-text text-decoration-none text-gray-500" id="signUpPasswordCaption" data-toggle="password" href="index.html#signUpPassword">
                  <i class="fe fe-eye"></i>
                </a>
              </div>
            </div>
    ...
    <div class="modal-content">
      <div class="modal-body text-center">
        ...
        <form class="mb-6">
          ...
          <!-- Email -->
          <div class="form-group">
            <label class="sr-only" for="passwordResetEmail">
              Your email
            </label>
    ...
    <div class="modal-content">
      <div class="modal-body text-center">
        ...
        <form class="mb-6">
          ...
          <!-- Email -->
          <div class="form-group">
            <label class="sr-only" for="saleModalEmail">
              Your email
            </label>
        ...
        <!-- Text -->
        <small class="text-muted">
          <a class="text-reset" data-dismiss="modal" href="index.html#!">No thanks, I hate free stuff.</a>
        </small>
